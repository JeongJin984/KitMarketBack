...
//
//            for(int i = 0; i<30; i++){
//                Study study = new Study("Study" + i, "I'm Study" + i, "i love study" + i);
...
//
//            for(int i = 0; i<30; i++){
//                CarFull carFull = new CarFull("CarFull" + i, "I'm CarFull" + i, "i love carFull" + i);
...
//            }
//            for(int i = 0; i<30; i++){
//                Contest contest = new Contest("CarFull" + i, "I'm CarFull" + i, "i love carFull" + i);
